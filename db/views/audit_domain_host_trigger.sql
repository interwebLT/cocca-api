...
BEGIN
PERFORM
DBLINK_EXEC('dbname=cocca user=coccauser password=coccauser', 'INSERT INTO registry_sync_domain_hosts(audit_transaction, audit_operation, domain_name, host_name, ' ||
