  ...
  factory :audit_domain, class: Audit::Domain do
    ...
    factory :register_domain do
      ...
      after :create do |domain|
        create :register_ledger, audit_transaction: domain.txn, domain_name: domain.name
        create :audit_domain_event, audit_transaction: domain.txn, domain_name: domain.name
      end
    ...
    factory :update_domain do
      ...
      factory :transfer_domain do
        ...
        after :create do |domain|
          create :transfer_ledger, audit_transaction: domain.txn, domain_name: domain.name
        end
      end
      ...
      factory :renew_domain do
        ...
        after :create do |domain|
          create :renew_ledger, audit_transaction: domain.txn, domain_name:  domain.name
